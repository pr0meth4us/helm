...
export const projects: Project[] = [
    {
        ...
        tagline: 'Personal Economic Surveillance',
        category: 'Finance',
        description: 'A dedicated financial interception unit. Logs every capital flow in & out via Telegram protocol. Designed for total situational awareness of personal assets. Currently deployed as a live bot.',
        ...
        links: [
            ...
            { label: 'View Source', url: 'https://github.com/pr0meth4us/monolith-services', type: 'github' }
        ]
    },
    {
        id: 'project-404',
        ...
        links: [
            ...
            {
                label: 'Get Yours Customized',
                url: 'mailto:phearaneron.soeung@gmail.com?subject=I want a custom 404 Project site',
                type: 'dedicated-site'
            }
        ]
    },
    {
        id: 'lpr-system',
        slug: 'cambodia-lpr',
        title: 'Optical Surveillance: LPR',
        tagline: 'Computer Vision for Chaotic Traffic',
        category: 'AI/ML',
    ...
    },
    {
        ...
        tagline: 'Standardizing Digital Sovereignty',
        category: 'Government',
    ...
    },
    {
        ...
        tagline: 'Digital Archeology & Restoration',
        category: 'Tool',
    ...
    },
    {
        ...
        tagline: 'Social Dynamics Quantified',
        category: 'AI/ML',
        ...
        isCommercial: false,
        links: [
            { label: 'LAUNCH APP', url: 'https://chat-analysis-beryl.vercel.app/', type: 'demo' }, // Main Landing Page [cite: 859]
            { label: 'VIEW DASHBOARD', url: 'https://chat-analysis-beryl.vercel.app/demo', type: 'demo' }, // Dashboard Demo [cite: 860]
            { label: 'BLUEPRINT', url: 'https://github.com/pr0meth4us/chat-analysis', type: 'github' } // GitHub [cite: 858]
        ]
    },
    {
        id: 'ecampus',
        ...
        tagline: 'Zero-Cost Educational Infrastructure',
        category: 'Education',
    ...
    },
    {
        ...
        tagline: 'Entropy Reduction for Teams',
        category: 'Tool',

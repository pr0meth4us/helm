...
import { ArrowLeft, Github, Globe, ExternalLink, Terminal, Cpu, Radio, Lock } from 'lucide-react';
                              ...
                              CLASSIFIED
                                        ...
                                        return (
                                            <a
                                                ...
                                                className={`
                          flex items-center justify-between w-full px-4 py-3 text-sm font-bold tracking-wide transition-all duration-300 border rounded
                          ${isPrimary
